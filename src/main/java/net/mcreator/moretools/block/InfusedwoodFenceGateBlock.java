...
public class InfusedwoodFenceGateBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_fence_gate")
	public static final Block block = null;
	public InfusedwoodFenceGateBlock(MoretoolsModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_fence_gate");
		}
