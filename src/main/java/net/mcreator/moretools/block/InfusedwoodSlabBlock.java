...
public class InfusedwoodSlabBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_slab")
	public static final Block block = null;
	public InfusedwoodSlabBlock(MoretoolsModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_slab");
		}
