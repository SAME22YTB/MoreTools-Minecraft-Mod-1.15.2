...
public class InfusedwoodStairsBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_stairs")
	public static final Block block = null;
	public InfusedwoodStairsBlock(MoretoolsModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_stairs");
		}
