...
public class InfusedwoodFenceBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_fence")
	public static final Block block = null;
	public InfusedwoodFenceBlock(MoretoolsModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_fence");
		}
