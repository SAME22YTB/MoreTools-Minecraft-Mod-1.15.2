...
public class InfusedwoodLogBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_log")
	public static final Block block = null;
	public InfusedwoodLogBlock(MoretoolsModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_log");
		}
