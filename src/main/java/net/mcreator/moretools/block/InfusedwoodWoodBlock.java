...
public class InfusedwoodWoodBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_wood")
	public static final Block block = null;
	public InfusedwoodWoodBlock(MoretoolsModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_wood");
		}
