...
public class InfusedwoodPlanksBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_planks")
	public static final Block block = null;
	public InfusedwoodPlanksBlock(MoretoolsModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_planks");
		}
