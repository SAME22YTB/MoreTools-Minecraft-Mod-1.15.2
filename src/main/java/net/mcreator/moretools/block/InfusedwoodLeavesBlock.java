...
public class InfusedwoodLeavesBlock extends MoretoolsModElements.ModElement {
	@ObjectHolder("moretools:infusedwood_leaves")
	public static final Block block = null;
	public InfusedwoodLeavesBlock(MoretoolsModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("infusedwood_leaves");
		}
